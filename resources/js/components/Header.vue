                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" title="User menu" data-toggle="dropdown">
                                <figure class="avatar avatar-sm">
                                    <img :src="'../../assets/media/image/user/avatar.png'" class="rounded-circle"
                                         alt="avatar">
                                </figure>
                                <span class="ml-2 d-sm-inline d-none">asas</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                                <div class="text-center py-4" data-background-image="">
                                    <figure class="avatar avatar-lg mb-3 border-0">
                                        <img :src="'../../assets/media/image/user/avatar.png'" class="rounded-circle" alt="image">
                                    </figure>
